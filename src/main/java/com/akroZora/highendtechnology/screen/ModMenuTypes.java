...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.CONTAINERS, HighEndTechnology.MOD_ID);

    public static final RegistryObject<MenuType<AssemblyStationMenu>> ASSEMBLY_STATION_MENU =
